...
export default function Contact() {
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[calc(100vh-80px)] py-16 md:py-24 bg-black overflow-hidden select-none flex items-center">
        {/* Planetary Horizon Glow Background (Image 2) */}
        <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            >
              <div>
                ...
                {/* Main Headline */}
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tight leading-[1.08] mb-4">
                  Let&apos;s Build
                  <br />
