...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[92vh] w-full flex flex-col justify-end overflow-hidden bg-black -mt-20">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/30 to-[#0d0d0f] pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/40 to-black/50 pointer-events-none" />

        {/* Center Watermark: Outlined Hexagon Logo Mark */}
        <div className="absolute top-[46%] left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-10 flex items-center justify-center">
          <GrowviaLogoMark
            className="w-20 h-20 md:w-28 md:h-28 text-[#F5F0E6]/80 drop-shadow-[0_4px_24px_rgba(0,0,0,0.9)]"
            strokeWidth={1.7}
          />
        </div>
        ...
        <div className="relative z-20 max-w-7xl w-full mx-auto px-6 sm:px-8 lg:px-12 pb-14 sm:pb-16 pt-36">
          <div className="max-w-2xl">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-white mb-4 leading-[1.08] drop-shadow-[0_2px_16px_rgba(0,0,0,0.9)]"
            >
              Find Your Path.
              <br />
              <span className="text-[#E69D43]">Kill It in Life.</span>
            </motion.h1>
            ...
            >
              ...
              <Link
                href="/roadmaps"
                className="inline-flex items-center justify-center gap-2 px-7 py-3 rounded-full bg-[#F5F0E6] text-[#121212] font-semibold text-sm md:text-base hover:bg-white transition-all duration-300 shadow-xl shadow-black/50 group"
              >
              ...
              <Link
                href="/career-quiz"
                className="inline-flex items-center justify-center px-7 py-3 rounded-full border border-white/25 bg-black/40 backdrop-blur-md text-white font-medium text-sm md:text-base hover:bg-white/10 hover:border-white/50 transition-all duration-300 shadow-lg shadow-black/30"
              >
                Take Career Quiz
              </Link>
            </motion.div>

            {/* Metric Chips & Social Proof */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.45 }}
              className="flex flex-wrap items-center gap-5 text-xs sm:text-sm text-white/80"
            >
              <div className="flex items-center gap-1.5">
                <BookOpen className="w-3.5 h-3.5 text-[#E69D43]" />
                <span className="font-medium">48 Careers</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Building2 className="w-3.5 h-3.5 text-[#E69D43]" />
                <span className="font-medium">20+ Industries</span>
              </div>
              <div className="flex items-center gap-1.5">
                <BarChart3 className="w-3.5 h-3.5 text-[#E69D43]" />
              ...
              <div className="flex items-center gap-1 text-amber-300">
                ...
                <span className="text-white/80 ml-1 font-light">4.9/5 (5,000+ guided)</span>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#0d0d0f] via-[#0d0d0f]/60 to-transparent pointer-events-none z-10" />
      </section>

      {/* ── MARQUEE TICKER ────────────────────────────────────── */}
      <div className="relative py-4 border-y border-white/[0.08] overflow-hidden bg-[#121215]">
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#0d0d0f] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#0d0d0f] to-transparent z-10 pointer-events-none" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i}
                className="bg-[#131316] border border-white/10 rounded-2xl px-6 py-7 text-center shadow-sm"
              >
                ...
                <div className="text-xs text-muted-foreground uppercase tracking-[0.14em] font-medium">
                  {s.label}
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white mb-3 tracking-tight">
              Why Most Students Are <span className="text-[#E69D43]">Stuck</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i}
                className="bg-[#131316] border border-white/10 hover:border-white/20 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 shadow-sm"
              >
                <div className="w-10 h-10 rounded-xl bg-white/[0.06] border border-white/10 flex items-center justify-center mb-5 text-[#E69D43]">
                  <item.icon size={20} />
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                custom={i}
                className="flex items-start gap-4 p-5 rounded-2xl bg-[#131316] border border-white/10"
              >
                <div className="w-10 h-10 rounded-xl bg-white/[0.06] border border-white/10 flex items-center justify-center text-[#E69D43] flex-shrink-0">
      ...
      {/* ── FEATURED ROADMAPS GRID (MATCHING REFERENCE UI) ───── */}
      <section className="py-20 bg-[#0d0d0f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight">
                Featured <span className="text-[#E69D43]">Roadmaps</span>
              </h2>
            ...
            <Link
              href="/roadmaps"
              className="text-amber-300/90 font-semibold hover:text-amber-200 flex items-center gap-1.5 text-xs sm:text-sm transition-colors group"
            >
          ...
          {/* 4-Column Compact Cards matching reference screenshot */}
                ...
                <Link key={career.id} href={`/roadmaps/${career.id}`}>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      {/* Concise Description: strictly 1-2 lines, never bulky */}
                      ...
                      <div className="pt-3 border-t border-white/[0.08] flex items-end justify-between gap-2 mt-auto">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-muted-foreground/75 block leading-tight">
                            Avg. Salary
                          </span>
                        </div>
      ...
      <section className="py-16 bg-[#0d0d0f]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="relative rounded-2xl border border-white/10 bg-[#131316] p-8 md:p-12 text-center overflow-hidden shadow-xl"
          >
            ...
            <div className="relative flex items-center justify-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-500/20 border border-amber-500/30 flex items-center justify-center text-sm font-bold text-amber-300">
                UB
              </div>
      ...
      {/* ── CTA BANNER ────────────────────────────────────────── */}
      <section className="py-24 bg-[#0d0d0f] relative overflow-hidden border-t border-white/5">
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-4 leading-tight">
              Stop Guessing.<br />
              <span className="text-[#E69D43]">Start Knowing.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                asChild
                size="lg"
                className="bg-[#F5F0E6] text-black hover:bg-white text-sm md:text-base h-12 px-8 rounded-full font-bold shadow-xl shadow-black/50 transition-all duration-300 hover:scale-105"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-white/15 text-white hover:bg-white/5 text-sm h-12 px-6 rounded-full"
              >
