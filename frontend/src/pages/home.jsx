...
export default function Home() {
  ...
  >
    ...
    { value: 99, suffix: "", label: "Rupees Only" },
  ...
  >
            ...
            <p className="text-muted-foreground">The system was never designed to give you honest career advice. We fix that.</p>
          </motion.div>
  ...
  >
            ...
            <div className="relative flex items-center justify-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-muted-foreground">Co-Founder, Growvia & Adfrenzy Media</div>
              </div>
            </div>
          </motion.div>
        </div>
