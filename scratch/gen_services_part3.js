  ...
  teacher: [
    {
      ...
      resources: [
        { name: "National Education Policy (NEP 2020) Guidelines", type: "reading", url: "https://education.gov.in", isFree: true },
        { name: "Khan Academy Teacher Community & Resources", type: "tool", url: "https://khanacademy.org", isFree: true },
        { name: "NCERT Official Curriculum & Exemplar Books", type: "book", url: "https://ncert.nic.in", isFree: true },
        { name: "Edutopia K-12 Educational Best Practices", type: "reading", url: "https://edutopia.org", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Regional Institute of Education (RIE NCERT) CEE Portal", type: "school", url: "https://cee.ncert.gov.in", isFree: true },
        { name: "CUET PG (B.Ed Examination Portal)", type: "tool", url: "https://pgcuet.samarth.ac.in", isFree: true },
        { name: "SWAYAM Teacher Training & MOOCs", type: "course", url: "https://swayam.gov.in", isFree: true },
        { name: "Teach For India Fellowship Preparation", type: "community", url: "https://teachforindia.org", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "National Council for Teacher Education (NCTE)", type: "reading", url: "https://ncte.gov.in", isFree: true },
        { name: "DIKSHA National Digital Platform for Teachers", type: "tool", url: "https://diksha.gov.in", isFree: true },
        { name: "Bloom's Taxonomy Revised Framework (Vanderbilt)", type: "reading", url: "https://cft.vanderbilt.edu", isFree: true },
        { name: "PhET Interactive Science & Math Simulations", type: "tool", url: "https://phet.colorado.edu", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "CTET Official Examination Portal (CBSE)", type: "tool", url: "https://ctet.nic.in", isFree: true },
        { name: "KVS (Kendriya Vidyalaya Sangathan) Recruitment Portal", type: "tool", url: "https://kvsangathan.nic.in", isFree: true },
        { name: "NVS (Navodaya Vidyalaya Samiti) Recruitment Portal", type: "tool", url: "https://navodaya.gov.in", isFree: true },
        { name: "International Baccalaureate (IB) Educator Certificates", type: "certification", url: "https://ibo.org", isFree: false }
      ],
  ...
  "ed-tech": [
    {
      ...
      resources: [
        { name: "3Blue1Brown Mathematical Visualization Philosophy", type: "video", url: "https://3blue1brown.com", isFree: true },
        { name: "Instructional Design Central (ADDIE & Modern Frameworks)", type: "reading", url: "https://instructionaldesigncentral.com", isFree: true },
        { name: "Coursera: Instructional Design Specialization", type: "course", url: "https://coursera.org", isFree: false },
        { name: "Notion for Curriculum Mapping & Lesson Architecture", type: "tool", url: "https://notion.so", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "OBS Studio (Open Broadcaster Software)", type: "tool", url: "https://obsproject.com", isFree: true },
        { name: "DaVinci Resolve Free Video Editor", type: "tool", url: "https://blackmagicdesign.com", isFree: true },
        { name: "Manim Community Edition (Mathematical Animation Engine)", type: "tool", url: "https://manim.community", isFree: true },
        { name: "YouTube Creator Academy & Analytics Guide", type: "reading", url: "https://youtube.com/creators", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Graphy by Unacademy / Classplus Platform for Educators", type: "tool", url: "https://graphy.com", isFree: false },
        { name: "Circle.so Community Platform", type: "tool", url: "https://circle.so", isFree: false },
        { name: "ConvertKit / Beehiiv Email Newsletters", type: "tool", url: "https://convertkit.com", isFree: true },
        { name: "Telegram Channels & Bot Automation for Quizzes", type: "tool", url: "https://telegram.org", isFree: true }
      ],
  ...
  journalist: [
    {
      ...
      resources: [
        { name: "The Indian Express 'Explained' Series", type: "reading", url: "https://indianexpress.com/section/explained", isFree: true },
        { name: "Frontline Magazine (The Hindu Group)", type: "reading", url: "https://frontline.thehindu.com", isFree: false },
        { name: "The Elements of Journalism by Bill Kovach and Tom Rosenstiel", type: "book", url: "https://crownpublishing.com", isFree: false },
        { name: "Columbia Journalism Review (CJR)", type: "reading", url: "https://cjr.org", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Bellingcat Open Source Investigation Guides", type: "reading", url: "https://bellingcat.com", isFree: true },
        { name: "Poynter Institute Fact-Checking Resources", type: "tool", url: "https://poynter.org", isFree: true },
        { name: "Knight Center for Journalism in the Americas MOOCs", type: "course", url: "https://journalismcourses.org", isFree: true },
        { name: "Reuters Institute Digital News Reports", type: "reading", url: "https://reutersinstitute.politics.ox.ac.uk", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Asian College of Journalism (ACJ Chennai)", type: "school", url: "https://asianmedia.org", isFree: false },
        { name: "Indian Institute of Mass Communication (IIMC New Delhi)", type: "school", url: "https://iimc.gov.in", isFree: false },
        { name: "Datawrapper (Data Visualization for Journalists)", type: "tool", url: "https://datawrapper.de", isFree: true },
        { name: "RTI Online (Right to Information Portal)", type: "tool", url: "https://rtionline.gov.in", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Press Council of India Guidelines & Code of Ethics", type: "reading", url: "https://presscouncil.nic.in", isFree: true },
        { name: "Investigative Reporters and Editors (IRE)", type: "community", url: "https://ire.org", isFree: false },
        { name: "Ramnath Goenka Excellence in Journalism Awards Archive", type: "reading", url: "https://rngfoundation.com", isFree: true },
        { name: "Signal Encrypted Messenger", type: "tool", url: "https://signal.org", isFree: true }
      ],
  ...
  "public-relations": [
    {
      ...
      resources: [
        { name: "Public Relations Society of India (PRSI)", type: "reading", url: "https://prsi.co.in", isFree: true },
        { name: "Ogilvy on Advertising by David Ogilvy", type: "book", url: "https://penguinrandomhouse.com", isFree: false },
        { name: "PRWeek Global News & Campaigns", type: "reading", url: "https://prweek.com", isFree: false },
        { name: "Reputation Today (Indian PR Magazine)", type: "reading", url: "https://reputationtoday.in", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Adfactors PR Learning & Career Resources", type: "reading", url: "https://adfactorspr.com", isFree: true },
        { name: "Meltwater Media Intelligence & Social Listening", type: "tool", url: "https://meltwater.com", isFree: false },
        { name: "HubSpot Academy: Digital PR & Inbound Strategy", type: "course", url: "https://academy.hubspot.com", isFree: true },
        { name: "Cision Media Monitoring Best Practices", type: "reading", url: "https://cision.com", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "SCoRe (School of Communications & Reputation)", type: "school", url: "https://scoreindia.org", isFree: false },
        { name: "Xavier Institute of Communications (XIC Mumbai)", type: "school", url: "https://xaviercomm.org", isFree: false },
        { name: "IIMC Advertising and Public Relations Department", type: "school", url: "https://iimc.gov.in", isFree: false },
        { name: "Institute for Public Relations (IPR Research)", type: "reading", url: "https://instituteforpr.org", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Holmes Report / PRovoke Media Global Agency Rankings", type: "reading", url: "https://provokemedia.com", isFree: true },
        { name: "PRAXIS (Annual Indian PR & Communications Summit)", type: "community", url: "https://praxis.scoremag.in", isFree: false },
        { name: "Crisis Communications Playbook by Jonathan Bernstein", type: "book", url: "https://bernsteincrisismanagement.com", isFree: false },
        { name: "International Public Relations Association (IPRA)", type: "community", url: "https://ipra.org", isFree: false }
      ],
  ...
  "fitness-trainer": [
    {
      ...
      resources: [
        { name: "Starting Strength by Mark Rippetoe", type: "book", url: "https://startingstrength.com", isFree: false },
        { name: "Human Anatomy & Physiology by Elaine Marieb", type: "book", url: "https://pearson.com", isFree: false },
        { name: "Renaissance Periodization (Dr. Mike Israetel) Exercise Science", type: "video", url: "https://youtube.com/@RenaissancePeriodization", isFree: true },
        { name: "Sports Authority of India (SAI) Youth Training Programs", type: "reading", url: "https://sportsauthorityofindia.nic.in", isFree: true }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Lakshmibai National Institute of Physical Education (LNUPE)", type: "school", url: "https://lnupe.edu.in", isFree: false },
        { name: "Netaji Subhas National Institute of Sports (NSNIS Patiala)", type: "school", url: "https://nsnis.org", isFree: false },
        { name: "Essentials of Strength Training and Conditioning (NSCA)", type: "book", url: "https://humankinetics.com", isFree: false },
        { name: "American Heart Association (AHA) CPR/AED Certification", type: "certification", url: "https://cpr.heart.org", isFree: false }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "American Council on Exercise (ACE CPT Certification)", type: "certification", url: "https://acefitness.org", isFree: false },
        { name: "NSCA Certified Strength and Conditioning Specialist (CSCS)", type: "certification", url: "https://nsca.com", isFree: false },
        { name: "NASM Certified Personal Trainer Portal", type: "certification", url: "https://nasm.org", isFree: false },
        { name: "Functional Movement Screen (FMS)", type: "tool", url: "https://functionalmovement.com", isFree: false }
      ],
    ...
    },
    {
      ...
      resources: [
        { name: "Precision Nutrition (Pn1 Nutrition Certification)", type: "certification", url: "https://precisionnutrition.com", isFree: false },
        { name: "Trainerize / TrueCoach Personal Training Software", type: "tool", url: "https://trainerize.com", isFree: false },
        { name: "MyFitnessPal Nutrition Tracking API", type: "tool", url: "https://myfitnesspal.com", isFree: true },
        { name: "Barbell Medicine Scientific Podcasts & Articles", type: "reading", url: "https://barbellmedicine.com", isFree: true }
      ],
